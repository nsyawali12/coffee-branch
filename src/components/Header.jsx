...
export default function Header({
  ...
  return (
    <header className="print:hidden bg-gradient-to-r from-indigo-800 via-indigo-700 to-violet-700 text-white">
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <h1 className="text-xl sm:text-2xl font-semibold">
              {isEmployeesTab ? 'Employee Performance Dashboard' : 'Sales Performance — Real Data'}
            </h1>
            <p className="text-sm text-indigo-200 mt-0.5">
              {isEmployeesTab
                ? 'Demo view — dummy data, monitoring employee performance vs target'
                : 'Real sales data from company records, Jan – Jun 2026'}
            </p>
          </div>
